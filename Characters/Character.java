...
public class Character 
{
    ...
    public Character Attack (Character dealer, Character target, int dmg, boolean aoe)
    {
        ...
        {
            nomiss=Damage_Stuff.CheckBlind(dealer);
            evade=Damage_Stuff.CheckEvade(dealer, target, nomiss);
    ...
    public Character AttackNoDamage (Character dealer, Character target, boolean aoe)
    {
        ...
        if (!(dealer.binaries.contains("Missed")))
        {
            boolean m=Damage_Stuff.CheckBlind(dealer);
            boolean e=Damage_Stuff.CheckEvade(dealer, target, m);
        }
    ...
    public int TakeDamageIgShield (Character target, int dmg, boolean aoe)
    {
        target.HP-=dmg;
        target.TookDamage (target, false, dmg);
        return dmg;
    }
