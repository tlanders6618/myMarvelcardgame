...
* Download the myMarvelcardgamelatest.jar file from above, by clicking on it and selecting "download" on the right hand side (the other is a backup, in case there's a major issue with the current version)
