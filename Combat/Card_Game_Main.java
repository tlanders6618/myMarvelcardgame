...
public class Card_Game_Main 
{
    ...
    public static void main (String[] args)
    {
        ...
        //Selecting cards
        System.out.println ("Welcome. Latest playable character: Winter Soldier (Classic). Please check the character overview list for the full list of playable characters.");
