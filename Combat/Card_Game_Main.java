...
public class Card_Game_Main 
{
    ...
    public static void main (String[] args)
    {
        ...
        //Selecting cards
        System.out.println ("Welcome. The current version is 4.4.16. The latest playable character is X-Ray (Classic). "); 
        System.out.println ("Currently, characters are playable from: 2.0, 2.1, 2.6, 2.7, 2.8, 2.9, and 2.10.");
