...
public class Ability_List_Player
{
    ...
    public static Ability MakeAbStarLord (int counter)
    {
        switch (counter)
        {
            ...
            return talon;
            case 1: HealAb pump= new HealAb ("Pump It Up", "AoE", "ally inclusive", 0); String[] dance= StatFactory.SetParam("Recovery", "300", "10", "2", "false");
    ...
    public static Ability MakeAbBucky (int counter)
    {
        switch (counter)
        {
            ...
            expert.special.add(new Extend (300, 2, "random", blood, privy, 1, true));
            return expert;
