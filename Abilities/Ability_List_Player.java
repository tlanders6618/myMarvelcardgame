...
public class Ability_List_Player
{
    public static Ability GetAb (int index, int counter)
    {
        ...
        switch (index) //since making a giant array of hundreds of elements was very slow, this should be faster, albeit longer
        {
            ...
            case 10: toret[0]=Ability_List_Player.MakeAbNickSr(counter); break;
            case 11: toret[0]=Ability_List_Player.MakeAbNickJr(counter); break;
            case 12: toret[0]=Ability_List_Player.MakeAbOGDrax(counter); break;
    ...
    public static Ability MakeAbOGDrax (int counter)
    {
        switch (counter)
        {
            case 0: BasicAb blast= new BasicAb ("Cosmic Blast", "single", "enemy", 45); blast.special.add(new DamageCounter ("false", false, "Obsession", 5));
            return blast;  
            case 1: BasicAb blow= new BasicAb ("Finishing Blow", "single", "enemy", 40); blow.special.add(new DamageCounterRemove ("Obsession", false, 40));
            return blow;
            case 2: return null;
            case 3: return null;            
            case 4: return null;
    ...
    public static Ability MakeAbNickJr (int counter)
    {
        switch (counter)
        {
            ...
            cloak.AddStatString(tech); String[] fast= StatFactory.SetParam("Speed", "100", "1", "1", "true"); cloak.AddStatString(fast);
            return cloak;
            case 3: OtherAb kill= new OtherAb ("Kill Mode", "self", "self", 0); kill.singleuse=true; kill.special.add(new ActivateP(11));
            return kill;
            case 4: AttackAb poke= new AttackAb ("Double Tap", "single", "enemy", 35, 2); poke.multihit=1;
            return poke;
        }
        return null; 
    }
    ...
    public static Ability MakeAbStarLord (int counter)
    {
        switch (counter)
        {
            ...
            return talon;
            case 1: HealAb pump= new HealAb ("Pump It Up", "AoE", "ally inclusive", 0); String[] dance= StatFactory.SetParam("Recovery", "500", "10", "2", "false");
    ...
    public static Ability MakeAbBucky (int counter)
    {
        switch (counter)
        {
            ...
            String[] blood= new String[1]; blood[0]="Countdown";
            String[] privy= new String[1]; privy[0]="any"; 
            expert.special.add(new Extend (500, 2, "random", blood, privy, 1, true));
            return expert;
            case 3: OtherAb det= new OtherAb("Detonator", "single", "enemy", 2); det.special.add(new Activate (false, "Countdown", 60)); det.attack=true;
    ...
    public static Ability MakeAbFalc (int counter)
    {
        switch (counter)
        {
            ...
            return eagle;
            case 4: AttackAb swarm= new AttackAb ("Bird Swarm", "AoE", "enemy", 70, 4); String[] scary=StatFactory.SetParam("Daze", "50", "1", "616", "false");
    ...
    public static Ability MakeAbCap (int counter)
    {
        switch (counter)
        {
            ...
            return bash;
            case 2: return null; 
            case 3: DefAb star= new DefAb ("Star Spangled Avenger", "self", "self", 3); String[] banner=StatFactory.SetParam("Taunt", "500", "1", "616", "true");
            star.AddStatString(banner); String[] whelmed= StatFactory.SetParam("Resistance", "500", "10", "1", "true"); star.AddStatString(whelmed);
            return star;
            case 4: HealAb lib= new HealAb ("Sentinel of Liberty", "AoE", "ally inclusive", 3); lib.special.add(new Confidence(500, 30));
            return lib;
        }
        return null; //in case something goes wrong, the default is null
    }
    public static Ability MakeAbWM (int counter)
    {
        switch (counter)
        {
            ...
            return ft;
            case 4: AttackAb army= new AttackAb ("Army of One", "single", "enemy", 120, 4); String[] holy=new String[1]; holy[0]="any";
            army.special.add (new BeforeNullify ("all", 100, 616, holy, true)); 
            return army;
        }
        return null; //in case something goes wrong, the default is null
    }
    public static Ability MakeAbIM (int counter)
    {
        switch (counter)
        {
            ...
            return miss; 
            case 2: HealAb recharge= new HealAb ("Recharge", "self", "self", 3); recharge.special.add (new Confidence (500, 30));  
            return recharge;
            case 3: BuffAb boost= new BuffAb ("Power Boost", "self", "self", 0); String[] Antidisestablishmentarianism= StatFactory.SetParam("Damage Up", "500", "30", "1", "true");
    ...
    public static Ability MakeAbPun (int counter)
    {
        switch (counter)
        {
            ...
            return supfire;
            case 2: BuffAb punwep= new BuffAb ("Weapons Expert", "self", "self", 0); String[] asunder=StatFactory.SetParam("Focus", "100", "2", "616", "true");
    ...
    public static Ability MakeAbMK (int counter) 
    {
        ...
        switch (counter)
        {
            ...
            return mbarr; 
            case 2: DefAb lunarp= new DefAb ("Lunar Protector", "single", "Ally exclusive", 2); String[] gloom=StatFactory.SetParam ("Protect", "500", "1", "616", "true");
