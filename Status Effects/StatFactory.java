...
public class StatFactory
{
    ...
    public static StatEff MakeStat (String[] param)
    {
        ...
        switch (param[0])
        {
            ...
            case "Daze": eff=new Daze (Integer.valueOf(param[1]), Integer.valueOf(param[2])); break;     
            case "Disrupt": eff=new Disrupt (Integer.valueOf(param[1]), Integer.valueOf(param[2])); break;
            case "Focus": eff=new Focus (Integer.valueOf(param[1]), Integer.valueOf(param[2])); break;
